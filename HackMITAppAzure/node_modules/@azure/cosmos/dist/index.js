(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('universal-user-agent'), require('tslib'), require('@azure/cosmos-sign'), require('debug'), require('binary-search-bounds'), require('priorityqueuejs'), require('semaphore'), require('crypto-hash'), require('fast-json-stable-stringify'), require('uuid/v4'), require('node-abort-controller'), require('node-fetch'), require('atob')) :
    typeof define === 'function' && define.amd ? define(['exports', 'universal-user-agent', 'tslib', '@azure/cosmos-sign', 'debug', 'binary-search-bounds', 'priorityqueuejs', 'semaphore', 'crypto-hash', 'fast-json-stable-stringify', 'uuid/v4', 'node-abort-controller', 'node-fetch', 'atob'], factory) :
    (factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}),global.userAgent,global.tslib_1,global.cosmosSign,global.debugLib,global.bs,global.PriorityQueue,global.semaphore,global.cryptoHash,global.stableStringify,global.uuid,global.AbortController,global.fetch,global.atob));
}(this, (function (exports,userAgent,tslib_1,cosmosSign,debugLib,bs,PriorityQueue,semaphore,cryptoHash,stableStringify,uuid,AbortController,fetch,atob) { 'use strict';

    userAgent = userAgent && userAgent.hasOwnProperty('default') ? userAgent['default'] : userAgent;
    debugLib = debugLib && debugLib.hasOwnProperty('default') ? debugLib['default'] : debugLib;
    ...
    stableStringify = stableStringify && stableStringify.hasOwnProperty('default') ? stableStringify['default'] : stableStringify;
    ...
    atob = atob && atob.hasOwnProperty('default') ? atob['default'] : atob;
    ...
    /** @hidden */
    function getPlatformDefaultHeaders() {
    ...
    function setAuthorizationTokenHeaderUsingMasterKey(verb, resourceId, resourceType, headers, masterKey) {
        ...
        headers = Object.assign(headers, cosmosSign.generateHeaders(masterKey, verb, resourceType, resourceId));
    }
    /**
     * @ignore
                ...
                try {
                    ...
                    if (this.options && this.options.bufferItems === true) {
                        ...
                        this.nextFetchFunction = fetchFunction
                            ? fetchFunction(Object.assign({}, this.options, { continuation: this.continuation }))
                            : undefined;
                    }
                }
                catch (err) {
    ...
    class PartitionKeyRangeCache {
        ...
        requestCollectionRoutingMap(collectionLink) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const { resources } = yield this.clientContext.queryPartitionKeyRanges(collectionLink).fetchAll();
        ...
        options, partitionedQueryExecutionInfo) {
            ...
            const createDocumentProducersAndFillUpPriorityQueueFunc = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const maxDegreeOfParallelism = options.maxDegreeOfParallelism === 0 || options.maxDegreeOfParallelism === undefined
                        ? 1
        ...
        nextItem() {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (result) {
                    ...
                    const hashedResult = yield cryptoHash.sha1(stringifiedResult);
        ...
        getAsyncIterator() {
            return tslib_1.__asyncGenerator(this, arguments, function* getAsyncIterator_1() {
                ...
                while (this.queryExecutionContext.hasMoreResults()) {
                    let response;
                    try {
                        response = yield tslib_1.__await(this.queryExecutionContext.fetchMore());
                    }
                    catch (error) {
                        if (this.needsQueryPlan(error)) {
                            yield tslib_1.__await(this.createPipelinedExecutionContext());
                            response = yield tslib_1.__await(this.queryExecutionContext.fetchMore());
                        }
                        else {
                            throw error;
        ...
        read(options = {}) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                if (this.partitionKey === undefined) {
                    const { resource: partitionKeyDefinition } = yield this.container.getPartitionKeyDefinition();
     ...
     * @ignore
     */
    function execute({ retryContext = {}, retryPolicies, requestContext }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // TODO: any response
            if (!retryPolicies) {
                retryPolicies = {
    ...
    function httpRequest(requestContext) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (response.status >= 400) {
                ...
                log$2.warn(response.status + " " + requestContext.endpoint + " " + requestContext.path + " " + result.message);
    ...
    class SessionContainer {
        ...
        static isReadingFromMaster(resourceType, operationType) {
            if (resourceType === Constants.Path.OffersPathSegment ||
                ...
                (resourceType === Constants.Path.CollectionsPathSegment && operationType === exports.OperationType.Query)) {
                return true;
            }
            return false;
        }
    ...
    class ClientContext {
        ...
        read({ path, resourceType, resourceId, options = {}, partitionKey }) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    request$$1.endpoint = yield this.globalEndpointManager.resolveServiceEndpoint(request$$1);
        ...
        queryFeed({ path, resourceType, resourceId, resultFn, query, options, partitionKeyRangeId, partitionKey }) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (query !== undefined) {
                    ...
                    request$$1.headers[Constants.HttpHeaders.ContentType] = Constants.MediaTypes.QueryJson;
                    if (typeof query === "string") {
                        request$$1.body = { query }; // Converts query text to query object.
                    }
                }
                this.applySessionToken(request$$1);
                log$3.info("query " + requestId + " started" + (request$$1.partitionKeyRangeId ? " pkrid: " + request$$1.partitionKeyRangeId : ""));
        ...
        applySessionToken(requestContext) {
            const request$$1 = this.getSessionParams(requestContext.path);
            ...
            if (request$$1.resourceAddress) {
                const sessionToken = this.sessionContainer.get(request$$1);
                if (sessionToken) {
        ...
        captureSessionToken(err, path, operationType, resHeaders) {
            const request$$1 = this.getSessionParams(path);
            request$$1.operationType = operationType;
            if (!err ||
                (!this.isMasterResource(request$$1.resourceType) &&
                ...
                this.sessionContainer.set(request$$1, resHeaders);
            }
        }
        clearSessionToken(path) {
            const request$$1 = this.getSessionParams(path);
            this.sessionContainer.remove(request$$1);
        }
        ...
        buildHeaders(requestContext) {
            return getHeaders({
                ...
                defaultHeaders: Object.assign({}, this.cosmosClientOptions.defaultHeaders, requestContext.options.initialHeaders),
        ...
        init() {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                if (this.initPromise === undefined) {
                    this.initPromise = this.refreshEndpointList().catch((error) => error); // Without this catch, node reports an unhandled rejection. So we stash the promise as resolved even if it errored.
                }
                return this.initPromise;
            });
        }
    ...
    class CosmosClient {
        constructor(optionsOrConnectionString) {
            ...
            const globalEndpointManager = new GlobalEndpointManager(optionsOrConnectionString, (opts) => tslib_1.__awaiter(this, void 0, void 0, function* () { return this.getDatabaseAccount(opts); }));
    ...
    class StoredProcedure {
        ...
        execute(partitionKey, params, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield this.clientContext.execute({ sprocLink: this.url, params, options, partitionKey });
                return new ResourceResponse(response.result, response.headers, response.code);
            });
        }
    }
    ...
    class UserDefinedFunction {
        ...
        delete(options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = getPathFromLink(this.url);
                const id = getIdFromLink(this.url);
                const response = yield this.clientContext.delete({ path, resourceType: ResourceType.udf, resourceId: id, options });
                return new UserDefinedFunctionResponse(response.result, response.headers, response.code, this);
            });
        }
    }
